...
\section{\tb{differetial flatness}}
...
como encontrar la función $u(t)$ tal que, el estado $x(t)$ sigue la trayectoria desesada $x^{des}(t)$ a lo largo del tiempo.\tb{profundizar en la forma de la trayectoria , posicion, velocidad y aceleración}\\
